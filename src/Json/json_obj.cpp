...
bool JsonObj::boolean2(const QString & key1, const int & index2) { return JOBJ_KEY2SI(key1, index2).toBool(); }
...
int JsonObj::integer2(const QString & key1, const int & index2) { return JOBJ_KEY2SI(key1, index2).toInt(); }
...
qint64 JsonObj::bigInt2(const QString & key1, const int & index2) { return JOBJ_BINT(JOBJ_KEY2SI(key1, index2)); }

double JsonObj::rational(const QString & key) { return val(key).toDouble(); }
double JsonObj::rational2(const QString & key1, const QString & key2) { return JOBJ_KEY2SS(key1, key2).toDouble(); }
double JsonObj::rational2(const QString & key1, const int & index2) { return JOBJ_KEY2SI(key1, index2).toDouble(); }
...
QString JsonObj::forceString2(const QString & key1, const int & index2) { return J_STR(JOBJ_KEY2SI(key1, index2)); }
