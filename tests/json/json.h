...
public:
    ...
    virtual Json val(const int & index1, const int & index2);
    virtual Json val(const int & index1, const QString & key2);
    virtual Json val(const QString & key1, const QString & key2);
    ...
    virtual JsonObj obj(const int & index1, const QString & key2);
    ...
    virtual JsonArr arr(const int & index1, const QString & key2);
    ...
    virtual QString string(const QString & key1, const int & index2);

    virtual QString forceString();
    virtual QString forceString(const int & index);
    virtual QString forceString(const QString & key);
    virtual QString forceString(const int & index1, const int & index2);
    virtual QString forceString(const int & index1, const QString & key2);
    virtual QString forceString(const QString & key1, const QString & key2);
    virtual QString forceString(const QString & key1, const int & index2);
};
